...
namespace ROCKY_NAMESPACE
{
    ...
    public:
        ...
        //! Saturation adjustment in Mapbox-style range [-1, 1], where 0 is unchanged.
        option<float> saturation = 0.0f;

        //! Contrast adjustment in Mapbox-style range [-1, 1], where 0 is unchanged.
        option<float> contrast = 0.0f;
