...
namespace ROCKY_NAMESPACE
{
    ...
    public:
        ...
        //! Set when VSG compilation fails; callers must not record incomplete state.
        std::atomic_bool compileFailed = { false };

        //! Prevents repeated log spam once rendering has been blocked after a compile failure.
        std::atomic_bool compileFailureRecordBlockLogged = { false };
