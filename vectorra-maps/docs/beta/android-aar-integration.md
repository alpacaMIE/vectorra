...
```kotlin
dependencies {
    implementation("com.vectorra:vectorra-maps:0.3.0-beta.1")
}
```
...
```kotlin
dependencies {
    implementation("com.vectorra:vectorra-maps-turf:0.3.0-beta.1")
}
```
...
This mode reads `com.vectorra:vectorra-maps:0.3.0-beta.1` from `mavenLocal()`.
