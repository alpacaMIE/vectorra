...
- `test-device-smoke-result-checker.ps1`: passed, including invalid screenshot PNG, missing device metadata, empty device metadata, blank snapshot rejection, and missing 3D Tiles zoom-snapshot rejection
